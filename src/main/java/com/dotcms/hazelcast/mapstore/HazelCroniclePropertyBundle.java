 ...
 */
public class HazelCroniclePropertyBundle {
    private static final String PROPERTY_FILE_NAME = "CronicleMapStore.properties";
    private static Properties properties;
    static {
        properties = new Properties();
        try {
            InputStream in = HazelCroniclePropertyBundle.class
                            .getResourceAsStream("/" + PROPERTY_FILE_NAME);
            if (in == null) {
                in = HazelCroniclePropertyBundle.class.getResourceAsStream(
